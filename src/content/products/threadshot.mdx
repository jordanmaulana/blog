---
name: Threadshot
tagline: Turn any public Threads post into a clean, shareable PNG.
url: https://threadshot.net
stack:
  - FastAPI
  - Playwright
  - Jinja2
...
Working prototype. Monetization is stubbed (`ADSENSE_CLIENT`, `GA_MEASUREMENT_ID` env vars) but no business model is locked in yet.
